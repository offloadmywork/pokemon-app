...
- ✅ Automated accessibility gate (2026-08-26): axe-core audits (`src/accessibility.a11y.test.jsx`) run in CI on six core panels (Daily Quests, Weekly Missions, Shop, Collection Mastery, Achievements, Challenge Tower) and fail the suite on serious/critical violations; all six pass clean
